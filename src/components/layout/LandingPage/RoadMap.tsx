...
export const RoadMap = () => {
  const [roadMapImg, setRoadMapImg] = React.useState(
    window.innerWidth > 800 ? dotRoadmap : dotRoadmapMobile
  );
        ...
        <div className="content-evenly grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          <div className="floater">
            <h3
              data-aos="fade-right"
              data-aos-delay="300"
              className="font-bold app-font text-2xl mt-8"
            >
              Our Roadmap for 2022
            </h3>
            <p>
              Roadmap will continuously change as we progress with our project.
              For updates and news, join our Telegram announcement channel
            </p>
          </div>
          <img
            className="col-span-3 row-span-3 dot_img"
            style={{ marginTop: `${window.innerWidth > 800 ? "-300px" : "0"}` }}
            src={roadMapImg}
            alt="DotLaunch Roadmap"
          />
        </div>
      </AppContainer>
    </div>
