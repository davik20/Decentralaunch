          ...
          <div className="flex flex-col">
            <div className="flex flex-col w-full pt-16 lg:m-0 text-center">
                  ...
                  <TypeWriter
                    ...
                    onInit={(typewriter) => {
                      typewriter
                        .changeDelay(20)
                        .typeString(
                          "We are the leading decentralized cronos-chain launchpad protocol in crypto. "
                        )
                        .pauseFor(1000)
                        .deleteAll(10)
                        .typeString(
                          "A One-Stop platform to invest in a variety of diversified blockchain projects"
                        )
                        .pauseFor(1000)
                        .deleteAll(10)
                        .start();
              ...
              <div className="flex space-x-4 mb-8 justify-center">
                ...
                <Link to="/app" data-aos="fade" data-aos-delay="800">
                  <SecondaryButton
                    onClick={() => {
